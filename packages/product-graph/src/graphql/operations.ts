...
export const MATERIAL_ASSET_REVISIONS_QUERY = `
  query MaterialAssetRevisions($materialAssetId: String!) {
    materialAssetRevisions(materialAssetId: $materialAssetId) {
      id
      materialAssetId
      version
      status
...
export const PUBLISH_MATERIAL_ASSET_MUTATION = `
  mutation PublishMaterialAsset($id: String!) {
    publishMaterialAsset(id: $id) {
      id
      currentRevisionId
      publishedRevisionId
      hasDraft
...
export const PUBLISH_OBJECT_ASSET_MUTATION = `
  mutation PublishObjectAsset($id: String!) {
    publishObjectAsset(id: $id) {
      id
      version
      status
      contentHash
...
export const CREATE_VISUAL_SETUP_MUTATION = `
  mutation CreateVisualSetup($input: CreateVisualSetupInput!) {
    createVisualSetup(input: $input) {
      id
    }
  }
`;

export const UPDATE_VISUAL_SETUP_MUTATION = `
  mutation UpdateVisualSetup($input: UpdateVisualSetupInput!) {
    updateVisualSetup(input: $input) {
      id
      valueJson
      operation
    }
...
export const DELETE_VISUAL_SETUP_MUTATION = `
  mutation DeleteVisualSetup($id: String!) {
    deleteVisualSetup(id: $id)
  }
`;
