...
exports.buildDemoChairGlb = buildDemoChairGlb;
exports.buildDemoChairBundle = buildDemoChairBundle;
const core_1 = require("@gltf-transform/core");
const parse_glb_1 = require("../src/library/parse-glb");
async function buildDemoChairGlb() {
    const { bytes } = await buildDemoChairBundle();
    return bytes;
}
async function buildDemoChairBundle() {
    ...
    const metadata = (0, parse_glb_1.buildMetadataFromDocument)(document, {
        assetName: 'Demo Chair',
        format: 'glb',
    });
    return { bytes, metadata };
}
//# sourceMappingURL=demo-chair-glb.js.map