  ...
  "effects": [
    {
      ...
      "materialAssetId": "mat_velvet_emerald",
      "documentUrl": "/documents/materials/mat_velvet_emerald",
      "valueJson": "{\"materialAssetId\":\"mat_velvet_emerald\"}"
    }
  ]
}
```
...
- `SET_MATERIAL` points to the material asset to apply to a material-slot target.
